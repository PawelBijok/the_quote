...
import '../../features/start/presentation/cubit/start_cubit.dart' as _i23;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i23.StartCubit>(
        () => _i23.StartCubit(gh<_i14.AuthRepository>()));
    gh.factory<_i24.AddOrEditCollectionCubit>(
        () => _i24.AddOrEditCollectionCubit(gh<_i16.CollectionRepository>()));
    gh.lazySingleton<_i25.AuthCubit>(
        () => _i25.AuthCubit(gh<_i14.AuthRepository>()));
